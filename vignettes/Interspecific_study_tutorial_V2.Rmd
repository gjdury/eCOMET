...
sample_richness <- GetAlphaDiversity(mmo, q = 0, normalization = 'None',mode = 'unweighted',richness_threshold = 0)
...
p <- PlotAccumulation(group_rarefied_richness_V2)
p


group_rarefied_richness_V2
...
## MS will add this
mmo <- ecomet::ReplaceZero(mmo,method = "one")

PCAplot(mmo, normalization = 'None')
...
3) We illustrate how different species of trees share a small fraction of there mz-rt features and show how this can be useful for identifying chemotypes. 
