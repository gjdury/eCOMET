<!-- TODO: Replace demo data files in inst/extdata/tutorials/interspecific/ with
     properly reduced small versions (<1 MB each). The feature table and dreams
     similarity matrix are currently full-size copies and will bloat the package.
     Subset to a representative set of features before enabling eval=TRUE. -->

---
title: "Tutorial 3: Compound Dendrograms and Molecular Networks"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Tutorial 3: Compound Dendrograms and Molecular Networks}
