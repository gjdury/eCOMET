...
ggsave("plots_for_publication/Fig4a_sample_richness.png", Sample_Richness,
...
```{r, eval=FALSE, echo=FALSE}
ggsave("plots_for_publication/Fig4b_accumulation_curve.png", compound_accumlation_curve,
       width = 8, height = 5, dpi = 400)
...
```{r, eval=FALSE, echo=FALSE}
ggsave("plots_for_publication/Fig4c_npc_stacked_bar.png", p_stacked,
...
```{r, eval=FALSE, echo=FALSE}
ggsave("plots_for_publication/Fig4d_hc_bray.png",
...
We can also control the beta diversity metrix in a PCOA plot. Here we use the Gen.Uni
```{r, eval = FALSE}
...
To compare how clusters differ when we incorporate structurally weighted beta distances, we place Bray-Curtis and Generalized UniFrac (d_1) PCoAs side by side. Because the two distance matrices are on different scales, each panel has free axes — interpret only the relative grouping of points across panels, not the axis values.
...
```{r, eval=FALSE, echo=FALSE}
ggsave("plots_for_publication/Figure4e_pcoa_comparison.png",
