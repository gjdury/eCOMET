...
# 8. structure-awarealpha diversity
...
5.  Decide whether to create a separate dendrogram tutorial and, if so, add a link to it from this vignette.
6.  Decide whether to add dendrogram export options for iTOL or FigTree, NPC pathway coloring, and associated abundance barplots.
7.  Dale will update this to add GNPS both for creating a chemical distance and for adding annotations.
8.  Clean up tutorials on website and push
