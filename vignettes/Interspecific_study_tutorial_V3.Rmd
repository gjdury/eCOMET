...
NMDS <- NMDSplot(mmo, betadiv = beta_diversity_dreams_CSCS, outdir = 'output/NMDS', width = 6, height = 6)
...
1) plotting functions are still not working well in R. We need a unified plan for how to actually save outputs and or return the plots.
2) Some issues with the assumptions of getbetadiversity and need to unifiy how relative abundance is calculated... this was reordering in the cscs calculation
