...
Following input files are required. See ‘/raw\_data’ of demo files. 1)
...
features (‘custom\_DB\_glucosinolates.csv’) The custom DB includes three
...
The demo files are metabolomics analysis files of Arabidopsis thaliana
