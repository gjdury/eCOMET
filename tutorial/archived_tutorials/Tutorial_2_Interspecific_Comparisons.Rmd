...
vignette: >
  %\VignetteIndexEntry{Tutorial 2: Interspecific Ecometabolomics}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

 > **Run this tutorial interactively:** [Download the notebook (.Rmd)](https://raw.githubusercontent.com/Phytoecia/eCOMET/main/tutorial_notebooks/Tutorial_2_Interspecific_notebook.Rmd) — open in RStudio and run chunks with Ctrl+Enter.
...
ggsave("/Users/dlforrister/Library/CloudStorage/OneDrive-SmithsonianInstitution/One_Drive_BackUps_Local_Mac_Files/CODE_GIT_HUB_2017_Aug_31/eCOMET/vignettes/plots_for_publication/Fig4a_sample_richness.png", Sample_Richness,
       width = 8, height = 5, dpi = 400)
ggsave("plot/T2_sample_richness.png", Sample_Richness, width = 7, height = 5, dpi = 100)
```

```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("plot/T2_sample_richness.png")
```
...
```{r, eval=FALSE, echo=FALSE}
ggsave("/Users/dlforrister/Library/CloudStorage/OneDrive-SmithsonianInstitution/One_Drive_BackUps_Local_Mac_Files/CODE_GIT_HUB_2017_Aug_31/eCOMET/vignettes/plots_for_publication/Fig4b_accumulation_curve.png", compound_accumlation_curve,
       width = 8, height = 5, dpi = 400)
ggsave("plot/T2_accumulation_curve.png", compound_accumlation_curve, width = 8, height = 5, dpi = 100)
```

```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("plot/T2_accumulation_curve.png")
```
...
```{r, eval=FALSE, echo=FALSE}
ggsave("plot/Rarefaction_AUC_Plot.png", Rarefaction_AUC_Plot, width = 8, height = 5, dpi = 100)
```

```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("plot/Rarefaction_AUC_Plot.png")
```
...
```{r, eval=FALSE, echo=FALSE}
ggsave("plot/T2_npc_pathway_prob.png", sirius_hist, width = 7, height = 5, dpi = 100)
```

```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("plot/T2_npc_pathway_prob.png")
```
...
```{r, eval=FALSE, echo=FALSE}
ggsave("plot/T2_cosmic_scores.png", cosmic_hist, width = 7, height = 5, dpi = 100)
```

```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("plot/T2_cosmic_scores.png")
...
```{r, eval=FALSE, echo=FALSE}
ggsave("/Users/dlforrister/Library/CloudStorage/OneDrive-SmithsonianInstitution/One_Drive_BackUps_Local_Mac_Files/CODE_GIT_HUB_2017_Aug_31/eCOMET/vignettes/plots_for_publication/Fig4c_npc_stacked_bar.png", p_stacked,
       width = 10, height = 6, dpi = 400)
ggsave("plot/T2_npc_stacked_bar.png", p_stacked, width = 8, height = 5, dpi = 100)
```

```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("plot/T2_npc_stacked_bar.png")
```
...
```{r, eval=FALSE, echo=FALSE}
ggsave("plot/T2_pca.png", mmo_pca$plot, width = 7, height = 6, dpi = 100)
```

```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("plot/T2_pca.png")
```
...
```{r, eval=FALSE, echo=FALSE}
ggsave("/Users/dlforrister/Library/CloudStorage/OneDrive-SmithsonianInstitution/One_Drive_BackUps_Local_Mac_Files/CODE_GIT_HUB_2017_Aug_31/eCOMET/vignettes/plots_for_publication/Fig4d_hc_bray.png",
  plot = hc_bray_plot, width = 10, height = 7, dpi = 300)
ggsave("plot/T2_hc_bray.png", hc_bray_plot, width = 8, height = 6, dpi = 100)
```

```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("plot/T2_hc_bray.png")
```
...
```{r, eval=FALSE, echo=FALSE}
ggsave("plot/T2_hc_cscs.png", hc_cscs$plot, width = 8, height = 6, dpi = 100)
```

```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("plot/T2_hc_cscs.png")
```
...
```{r, eval=FALSE, echo=FALSE}
ggsave("plot/T2_hc_genuni.png", hc_GenUni$plot, width = 8, height = 6, dpi = 100)
```

```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("plot/T2_hc_genuni.png")
```
...
```{r, eval=FALSE, echo=FALSE}
ggsave("plot/T2_nmds.png", NMDS$plot, width = 7, height = 6, dpi = 100)
```

```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("plot/T2_nmds.png")
```
...
```{r, eval=FALSE, echo=FALSE}
ggsave("plot/T2_pcoa.png", PCOA_example$plot, width = 7, height = 6, dpi = 100)
```

```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("plot/T2_pcoa.png")
```
...
```{r, eval=FALSE, echo=FALSE}
ggsave("/Users/dlforrister/Library/CloudStorage/OneDrive-SmithsonianInstitution/One_Drive_BackUps_Local_Mac_Files/CODE_GIT_HUB_2017_Aug_31/eCOMET/vignettes/plots_for_publication/Figure4e_pcoa_comparison.png",
  plot = pcoa_comparison, width = 14, height = 6, dpi = 300)
ggsave("plot/T2_pcoa_comparison.png", pcoa_comparison, width = 12, height = 5, dpi = 100)
```

```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("plot/T2_pcoa_comparison.png")
```
...
```{r, eval=FALSE, echo=FALSE}
ggsave("plot/T2_alpha_combined.png", combined_plot, width = 7, height = 8, dpi = 100)
```

```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("plot/T2_alpha_combined.png")
```
...
```{r, eval=FALSE, echo=FALSE}
ggsave("plot/T2_functional_hill_accumulation.png", functional_hill_compound_accumlation_curve, width = 8, height = 5, dpi = 100)
```

```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("plot/T2_functional_hill_accumulation.png")
```
